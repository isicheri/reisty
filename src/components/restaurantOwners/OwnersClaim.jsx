...
const OwnersClaim = () => {
  return (
    <div className="w-[100%] mb-8 grid grid-cols-1 lg:grid-cols-2 mt-16 gap-5">
      <div className="first px-[26px] pt-[82px] pb-4 lg:grid h-[450px] w-[350px] lg:w-[550px] lg:h-[463px] text-white lg:py-[45px] lg:pl-[30px]">
      ...
      <div className="grid lg:h-[463px] w-[100%] lg:flex"> 
        <div className="text py-[22px] px-[30px] lg:w-[60%] bg-[#F2F2F2] text-black lg:py-[45px] pl-[18px] pr-[8px]" >
        ...
        <div className="second order-[-1] lg:order-1 w-[90vw] h-[20vh] lg:h-full lg:w-[40%]"></div>
      </div>
    </div>
  );
};
