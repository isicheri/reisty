...
const Footer = () => {
  return (
    <>
    <div className='footerlg h-full w-[100%] bg-[#2B2B2B] gap-8 text-[#FFFFFF] px-8 pt-12 lg:hidden'>
    <div className='h-[200px] grid grid-cols-1 gap-5'>
                <div className="logo">
                    <img src={Logo} alt="" />
                </div>
            ...
            <div className='grid lg:flex justify-between pt-6 text-[14px]'>
                <div className=' text-center pb-'><p>&copy; 2022 Reisty.  All rights reserved.</p></div>
    ...
    <div className='footerlg h-[80vh] w-[100%] bg-[#2B2B2B] gap-8 text-[#FFFFFF] px-16 hidden lg:block'>
