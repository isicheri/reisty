       ...
       ""
        ...
        >
          <ul className="grid gap-6 ">
            ...
            <li className=" font-medium text-[18px]">Privacy and Policy</li>
            <li className=" font-medium text-[18px]">Terms of services</li>
            <li className=" font-medium text-[18px] pb-10 border-b-2">Cookie Policy</li>
          </ul>
